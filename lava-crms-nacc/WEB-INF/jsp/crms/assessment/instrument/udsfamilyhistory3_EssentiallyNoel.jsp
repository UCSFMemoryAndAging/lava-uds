    ...
    <page:applyDecorator name="component.instrument.section">
      ...
      <page:param name="instructions"> </page:param> 
		...
		<c:if test="${packetType == 'F' || packetType == 'T'}">
	      <tags:createField property="nwinfmut" component="${component}" entity="${instrTypeEncoded}" labelAlignment="left"/>
	    </c:if>  
      ...
      <c:if test="${packetType == 'F' || packetType == 'T'}">
	      <tags:createField property="nwinfpar" component="${component}" entity="${instrTypeEncoded}" labelAlignment="left"/>
	  </c:if>  
      ...
      <c:if test="${packetType == 'F' || packetType == 'T'}">
	      <tags:createField property="nwinfsib" component="${component}" entity="${instrTypeEncoded}" labelAlignment="left"/>
	  </c:if>  
      ...
      <c:if test="${packetType == 'F' || packetType == 'T'}">
	      <tags:createField property="nwinfkid" component="${component}" entity="${instrTypeEncoded}" labelAlignment="left"/>
	  </c:if>  
