...
<c:set var="instrTypeEncoded" value="udsftldimagingdiag3"/>
...
<page:applyDecorator name="component.instrument.section">
  	...
  	<page:param name="sectionNameKey">udsftldimagingdiag3.structural.section</page:param> 
  	<page:param name="view">${componentView}</page:param>
  	<page:param name="instructions"> </page:param>
...
<page:applyDecorator name="component.instrument.section">
  	...
  	<page:param name="sectionNameKey">udsftldimagingdiag3.fdgpet.section</page:param> 
  	<page:param name="view">${componentView}</page:param>
  	<page:param name="instructions"> </page:param>
...
<page:applyDecorator name="component.instrument.section">
  	...
  	<page:param name="sectionNameKey">udsftldimagingdiag3.amyloidpet.section</page:param> 
  	<page:param name="view">${componentView}</page:param>
  	<page:param name="instructions"> </page:param>
...
<page:applyDecorator name="component.instrument.section">
  	...
  	<page:param name="sectionNameKey">udsftldimagingdiag3.cbfspect.section</page:param> 
  	<page:param name="view">${componentView}</page:param>
  	<page:param name="instructions"> </page:param>
...
<page:applyDecorator name="component.instrument.section">
  	...
  	<page:param name="sectionNameKey">udsftldimagingdiag3.otherimaging.section</page:param> 
  	<page:param name="view">${componentView}</page:param>
  	<page:param name="instructions"> </page:param>  	  	  	  	
...
<ui:formGuide>
  <ui:observe elementIds="ftdidiag" component="${component}" forValue="^0"/>
...
<ui:formGuide>
  <ui:observe elementIds="ftdsmrio" component="${component}" forValue="^0"/>
  <ui:skip elementIds="ftdmrifa,ftdmrirf,ftdmrilf,ftdmrirt,ftdmrilt,ftdmrirm,ftdmrilm,ftdmrirp,ftdmrilp,ftdmrirb,ftdmrilb,ftdmriob,ftdmrios" component="${component}"/>
</ui:formGuide>

<ui:formGuide>
  <ui:observe elementIds="ftdmrifa" component="${component}" forValue="^1"/>
  <ui:unskip elementIds="ftdmrirf,ftdmrilf,ftdmrirt,ftdmrilt,ftdmrirm,ftdmrilm,ftdmrirp,ftdmrilp,ftdmrirb,ftdmrilb,ftdmriob,ftdmrios" component="${component}"/>
</ui:formGuide>

<ui:formGuide>
  <ui:observe elementIds="ftdmriob" component="${component}" forValue="^1"/>
  <ui:unskip elementIds="ftdmrios" component="${component}"/>
</ui:formGuide>

<ui:formGuide>
  <ui:observe elementIds="ftdfdgpe" component="${component}" forValue="^0"/>
  <ui:skip elementIds="ftdfdgfh,ftdfdgrf,ftdfdglf,ftdfdgrt,ftdfdglt,ftdfdgrm,ftdfdglm,ftdfdgrp,ftdfdglp,ftdfdgrb,ftdfdglb,ftdfdgoa,ftdfdgos" component="${component}"/>
</ui:formGuide>

<ui:formGuide>
  <ui:observe elementIds="ftdfdgfh" component="${component}" forValue="^1"/>
  <ui:unskip elementIds="ftdfdgrf,ftdfdglf,ftdfdgrt,ftdfdglt,ftdfdgrm,ftdfdglm,ftdfdgrp,ftdfdglp,ftdfdgrb,ftdfdglb,ftdfdgoa,ftdfdgos" component="${component}"/>
</ui:formGuide>

<ui:formGuide>
  <ui:observe elementIds="ftdfdgoa" component="${component}" forValue="^1"/>
  <ui:unskip elementIds="ftdfdgos" component="${component}"/>
</ui:formGuide>

<ui:formGuide>
  <ui:observe elementIds="ftdamyp" component="${component}" forValue="^0"/>
  <ui:skip elementIds="ftdamyvi,ftdamyrf,ftdamylf,ftdamyrt,ftdamylt,ftdamyrm,ftdamylm,ftdamyrp,ftdamylp,ftdamyrb,ftdamylb,ftdamyoa,ftdamyos" component="${component}"/>
</ui:formGuide>

<ui:formGuide>
  <ui:observe elementIds="ftdamyvi" component="${component}" forValue="^1"/>
  <ui:unskip elementIds="ftdamyrf,ftdamylf,ftdamyrt,ftdamylt,ftdamyrm,ftdamylm,ftdamyrp,ftdamylp,ftdamyrb,ftdamylb,ftdamyoa,ftdamyos" component="${component}"/>
</ui:formGuide>

<ui:formGuide>
  <ui:observe elementIds="ftdamyoa" component="${component}" forValue="^1"/>
  <ui:unskip elementIds="ftdamyos" component="${component}"/>
</ui:formGuide>

<ui:formGuide>
  <ui:observe elementIds="ftdcbfsp" component="${component}" forValue="^0"/>
  <ui:skip elementIds="ftdcbfvi,ftdcbfrf,ftdcbflf,ftdcbfrt,ftdcbflt,ftdcbfrm,ftdcbflm,ftdcbfrp,ftdcbflp,ftdcbfrb,ftdcbflb,ftdcbfoa,ftdcbfos" component="${component}"/>
</ui:formGuide>

<ui:formGuide>
  <ui:observe elementIds="ftdcbfvi" component="${component}" forValue="^1"/>
  <ui:unskip elementIds="ftdcbfrf,ftdcbflf,ftdcbfrt,ftdcbflt,ftdcbfrm,ftdcbflm,ftdcbfrp,ftdcbflp,ftdcbfrb,ftdcbflb,ftdcbfoa,ftdcbfos" component="${component}"/>
</ui:formGuide>

<ui:formGuide>
  <ui:observe elementIds="ftdcbfoa" component="${component}" forValue="^1"/>
  <ui:unskip elementIds="ftdcbfos" component="${component}"/>
</ui:formGuide>

<ui:formGuide simulateEvents="${(current == 0 && componentView != 'compare') || (current == 1) ? 'true' : ''}">
  <ui:observe elementIds="ftdothi" component="${component}" forValue="^1"/>
  <ui:unskip elementIds="ftdothis" component="${component}"/>
</ui:formGuide>
