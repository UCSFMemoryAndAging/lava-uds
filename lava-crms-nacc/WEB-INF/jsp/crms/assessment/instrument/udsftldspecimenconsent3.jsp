...
<c:set var="instrTypeEncoded" value="udsftldspecimenconsent3"/>
...
<ui:formGuide>
  <ui:observe elementIds="ftdrelco" component="${component}" forValue="^3"/>
  <ui:unskip elementIds="ftdsibby" component="${component}"/>
</ui:formGuide>
<ui:formGuide simulateEvents="${(current == 0 && componentView != 'compare') || (current == 1) ? 'true' : ''}">
  <ui:observe elementIds="ftdrelco" component="${component}" forValue="^4"/>
  <ui:unskip elementIds="ftdchdby" component="${component}"/>
</ui:formGuide>
