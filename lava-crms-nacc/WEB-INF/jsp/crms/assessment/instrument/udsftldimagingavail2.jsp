...
<c:set var="instrTypeEncoded" value="udsftldimagingavail2"/>
...
<ui:formGuide>
  <ui:observe elementIds="ftdsmri" component="${componentPrefix}" forValue="^0" comboRadioSelect="${componentMode == 'dc' ? 'true' : 'false'}"/>
  <ui:skip elementIds="ftdsmmo,ftdsmdy,ftdsmyr,ftdsmdic,ftdsmdis,ftdsmadn,ftdsmadv,ftdsmman,ftdsmmao,ftdsmmam,ftdsmfs,ftdsmfso,ftdsmqu" component="${componentPrefix}"/>
</ui:formGuide>

<ui:formGuide>
  <ui:observe elementIds="ftdsmdic" component="${componentPrefix}" forValue="^1" comboRadioSelect="${componentMode == 'dc' ? 'true' : 'false'}"/>
  <ui:unskip elementIds="ftdsmdis" component="${componentPrefix}"/>
</ui:formGuide>

<ui:formGuide>
  <ui:observe elementIds="ftdsmadn" component="${componentPrefix}" forValue="^1" comboRadioSelect="${componentMode == 'dc' ? 'true' : 'false'}"/>
  <ui:unskip elementIds="ftdsmadv" component="${componentPrefix}"/>
</ui:formGuide>

<ui:formGuide>
  <ui:observe elementIds="ftdsmman" component="${componentPrefix}" forValue="^4" comboRadioSelect="${componentMode == 'dc' ? 'true' : 'false'}"/>
  <ui:unskip elementIds="ftdsmmao" component="${componentPrefix}"/>
</ui:formGuide>

<ui:formGuide>
  <ui:observe elementIds="ftdsmfs" component="${componentPrefix}" forValue="^4" comboRadioSelect="${componentMode == 'dc' ? 'true' : 'false'}"/>
  <ui:unskip elementIds="ftdsmfso" component="${componentPrefix}"/>
</ui:formGuide>

<ui:formGuide>
  <ui:observe elementIds="ftdfdgpt" component="${componentPrefix}" forValue="^1" comboRadioSelect="${componentMode == 'dc' ? 'true' : 'false'}"/>
  <ui:unskip elementIds="ftdfpmo,ftdfpdy,ftdfpyr,ftdfddic,ftdfddid,ftdfdadn,ftdfdadv,ftdfdman,ftdfdmao,ftdfdmam,ftdfdqu" component="${componentPrefix}"/>
</ui:formGuide>

<ui:formGuide>
  <ui:observe elementIds="ftdfddic" component="${componentPrefix}" forValue="^1" comboRadioSelect="${componentMode == 'dc' ? 'true' : 'false'}"/>
  <ui:unskip elementIds="ftdfddid" component="${componentPrefix}"/>
</ui:formGuide>

<ui:formGuide>
  <ui:observe elementIds="ftdfdadn" component="${componentPrefix}" forValue="^1" comboRadioSelect="${componentMode == 'dc' ? 'true' : 'false'}"/>
  <ui:unskip elementIds="ftdfdadv" component="${componentPrefix}"/>
</ui:formGuide>

<ui:formGuide>
  <ui:observe elementIds="ftdfdman" component="${componentPrefix}" forValue="^4" comboRadioSelect="${componentMode == 'dc' ? 'true' : 'false'}"/>
  <ui:unskip elementIds="ftdfdmao" component="${componentPrefix}"/>
</ui:formGuide>

<ui:formGuide>
  <ui:observe elementIds="ftdamypt" component="${componentPrefix}" forValue="^1" comboRadioSelect="${componentMode == 'dc' ? 'true' : 'false'}"/>
  <ui:unskip elementIds="ftdammo,ftdamdy,ftdamyr,ftdamdic,ftdamdid,ftdamlig,ftdamlio,ftdamadn,ftdamadv,ftdamman,ftdammao,ftdammam,ftdamqu" component="${componentPrefix}"/>
</ui:formGuide>

<ui:formGuide>
  <ui:observe elementIds="ftdamdic" component="${componentPrefix}" forValue="^1" comboRadioSelect="${componentMode == 'dc' ? 'true' : 'false'}"/>
  <ui:unskip elementIds="ftdamdid" component="${componentPrefix}"/>
</ui:formGuide>

<ui:formGuide>
  <ui:observe elementIds="ftdamlig" component="${componentPrefix}" forValue="^3" comboRadioSelect="${componentMode == 'dc' ? 'true' : 'false'}"/>
  <ui:unskip elementIds="ftdamlio" component="${componentPrefix}"/>
</ui:formGuide>

<ui:formGuide>
  <ui:observe elementIds="ftdamadn" component="${componentPrefix}" forValue="^1" comboRadioSelect="${componentMode == 'dc' ? 'true' : 'false'}"/>
  <ui:unskip elementIds="ftdamadv" component="${componentPrefix}"/>
</ui:formGuide>

<ui:formGuide>
  <ui:observe elementIds="ftdamman" component="${componentPrefix}" forValue="^4" comboRadioSelect="${componentMode == 'dc' ? 'true' : 'false'}"/>
  <ui:unskip elementIds="ftdammao" component="${componentPrefix}"/>
</ui:formGuide>

<ui:formGuide>
  <ui:observe elementIds="ftdother" component="${componentPrefix}" forValue="^1" comboRadioSelect="${componentMode == 'dc' ? 'true' : 'false'}"/>
  <ui:unskip elementIds="ftdotdop,ftdotser,ftdotcho,ftdotano,ftdotans" component="${componentPrefix}"/>
</ui:formGuide>

<ui:formGuide simulateEvents="${(current == 0 && componentView != 'compare') || (current == 1) ? 'true' : ''}">
  <ui:observe elementIds="ftdotano" component="${componentPrefix}" forValue="^1" comboRadioSelect="${componentMode == 'dc' ? 'true' : 'false'}"/>
  <ui:unskip elementIds="ftdotans" component="${componentPrefix}"/>
</ui:formGuide>
