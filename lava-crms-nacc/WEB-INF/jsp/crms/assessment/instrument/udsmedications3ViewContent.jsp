...
<tags:list component="${component}">
	...
	<tags:listRow>
		<tags:listCell>
			<tags:listField property="drugId" component="${component}" listIndex="${iterator.index}" entityType="udsmedications3" mode="lv"/>			
		</tags:listCell>
		<tags:listCell>
			<tags:listField property="brand" component="${component}" listIndex="${iterator.index}" entityType="udsmedications3" mode="lv"/>
		</tags:listCell>
		<tags:listCell>
			<tags:listField property="generic" component="${component}" listIndex="${iterator.index}" entityType="udsmedications3" mode="lv"/>
			</tags:listCell>
		<tags:listCell>
			<tags:listField property="notListed" component="${component}" listIndex="${iterator.index}" entityType="udsmedications3" mode="lv"/>			
		</tags:listCell>
	</tags:listRow>
</tags:list>
