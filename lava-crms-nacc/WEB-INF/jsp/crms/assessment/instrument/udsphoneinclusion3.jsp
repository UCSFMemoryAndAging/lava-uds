...
<c:set var="instrTypeEncoded" value="udsphoneinclusion3"/>
...
<page:applyDecorator name="component.instrument.section">
  <page:param name="section"><spring:message code="udsphoneinclusion3.section"/></page:param>
  <page:param name="view">${componentView}</page:param>
...
<tags:listRow>
	<tags:listColumnHeader width="75%" labelKey="udsphoneinclusion3.1"/>
	<tags:listCell/>
</tags:listRow>
<tags:listRow>
	<tags:listCell><tags:outputText textKey="udsphoneinclusion3.1a" inline="false" indent="true"/></tags:listCell>
	<tags:listCell><tags:createField property="cogImp" component="${component}" entity="${instrTypeEncoded}"/></tags:listCell>
</tags:listRow>
<tags:listRow>
	<tags:listCell><tags:outputText textKey="udsphoneinclusion3.1b" inline="false" indent="true"/></tags:listCell>
	<tags:listCell><tags:createField property="physImp" component="${component}" entity="${instrTypeEncoded}"/></tags:listCell>
</tags:listRow>
<tags:listRow>
	<tags:listCell><tags:outputText textKey="udsphoneinclusion3.1c" inline="false" indent="true"/></tags:listCell>
	<tags:listCell><tags:createField property="home" component="${component}" entity="${instrTypeEncoded}"/></tags:listCell>
</tags:listRow>
<tags:listRow>
	<tags:listCell><tags:outputText textKey="udsphoneinclusion3.1d" inline="false" indent="true"/></tags:listCell>
	<tags:listCell><tags:createField property="refused" component="${component}" entity="${instrTypeEncoded}"/></tags:listCell>
</tags:listRow>
<tags:listRow>
	<tags:listCell><tags:outputText textKey="udsphoneinclusion3.1e" inline="false" indent="true"/></tags:listCell>
	<tags:listCell><tags:createField property="other" component="${component}" entity="${instrTypeEncoded}"/></tags:listCell>
</tags:listRow>
<tags:listRow>
	<tags:listCell><tags:outputText textKey="udsphoneinclusion3.1ex" inline="false" indent="true"/></tags:listCell>
...
<page:applyDecorator name="component.instrument.section">
	...
	<page:param name="view">${componentView}</page:param>
	<page:param name="instructions"> </page:param>
	<tags:createField property="notes['udsphoneinclusion3']" entity="${instrTypeEncoded}" component="${component}" metadataName="instrument.sectionNote" labelAlignment="top" dataStyle="instrNote"/>
</page:applyDecorator>
