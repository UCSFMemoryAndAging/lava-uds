...
<c:set var="instrTypeEncoded" value="udsftldformchecklist2"/>
...
<tags:listRow>
	<tags:listCell><tags:outputText textKey="udsftldformchecklist2.A3FForm"/></tags:listCell>
	<tags:listCell><tags:outputText textKey="udsftldformchecklist2.A3FDesc"/></tags:listCell>
	<tags:listCell><tags:createField property="ftda3fs" component="${component}" entity="${instrTypeEncoded}"/></tags:listCell>
	<tags:listCell><tags:createField property="ftda3fr" component="${component}" entity="${instrTypeEncoded}"/></tags:listCell>
	<tags:listCell><tags:createField property="ftda3fc" component="${component}" entity="${instrTypeEncoded}"/></tags:listCell>
</tags:listRow>
<tags:listRow>
...
<page:applyDecorator name="component.instrument.section">
	...
	<page:param name="view">${componentView}</page:param>
	<page:param name="instructions"> </page:param>
	<tags:createField property="notes['udsftldformchecklist2']" entity="${instrTypeEncoded}" component="${component}" metadataName="instrument.sectionNote" labelAlignment="top" dataStyle="instrNote"/>
</page:applyDecorator>
...
<ui:formGuide>
  <ui:observe elementIds="ftda3afs" component="${componentPrefix}" forValue="^0" comboRadioSelect="${componentMode == 'dc' ? 'true' : 'false'}"/>
  <ui:unskip elementIds="ftda3afr,ftda3afc" component="${componentPrefix}"/>
</ui:formGuide>
<ui:formGuide>
  <ui:observe elementIds="ftda3fs" component="${componentPrefix}" forValue="^0" comboRadioSelect="${componentMode == 'dc' ? 'true' : 'false'}"/>
  <ui:unskip elementIds="ftda3fr,ftda3fc" component="${componentPrefix}"/>
</ui:formGuide>
<ui:formGuide>
  <ui:observe elementIds="ftdc4fs" component="${componentPrefix}" forValue="^0" comboRadioSelect="${componentMode == 'dc' ? 'true' : 'false'}"/>
  <ui:unskip elementIds="ftdc4fr,ftdc4fc" component="${componentPrefix}"/>
</ui:formGuide>
<ui:formGuide>
  <ui:observe elementIds="ftdc5fs" component="${componentPrefix}" forValue="^0" comboRadioSelect="${componentMode == 'dc' ? 'true' : 'false'}"/>
  <ui:unskip elementIds="ftdc5fr,ftdc5fc" component="${componentPrefix}"/>
</ui:formGuide>
<ui:formGuide simulateEvents="${(current == 0 && componentView != 'compare') || (current == 1) ? 'true' : ''}">
  <ui:observe elementIds="ftdc6fs" component="${componentPrefix}" forValue="^0" comboRadioSelect="${componentMode == 'dc' ? 'true' : 'false'}"/>
  <ui:unskip elementIds="ftdc6fr,ftdc6fc" component="${componentPrefix}"/>
</ui:formGuide>
