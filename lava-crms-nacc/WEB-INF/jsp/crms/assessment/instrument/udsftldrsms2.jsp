...
<c:set var="instrTypeEncoded" value="udsftldrsms2"/>
...
<page:applyDecorator name="component.instrument.section">
	<page:param name="section"><spring:message code="udsftldrsms2.main.section"/></page:param>
	<page:param name="view">${componentView}</page:param>
...
<page:applyDecorator name="component.instrument.section">
	...
	<page:param name="view">${componentView}</page:param>
	<page:param name="instructions"> </page:param>
	<tags:createField property="notes['udsftldrsms2']" entity="${instrTypeEncoded}" component="${component}" metadataName="instrument.sectionNote" labelAlignment="top" dataStyle="instrNote"/>
</page:applyDecorator>
