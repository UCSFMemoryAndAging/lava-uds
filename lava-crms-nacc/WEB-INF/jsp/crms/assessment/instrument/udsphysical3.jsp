...
<page:applyDecorator name="component.instrument.section">
  <page:param name="section"><spring:message code="udsphysical3.subject.section"/></page:param>
  <page:param name="view">${componentView}</page:param>
...
<page:applyDecorator name="component.instrument.section">
  <page:param name="section"><spring:message code="udsphysical3.addtl.section"/></page:param>
  <page:param name="view">${componentView}</page:param>
  <page:param name="instructions"> </page:param>
...
<ui:formGuide>
  <ui:observe elementIds="visCorr" component="${component}" forValue="^1"/>
  <ui:unskip elementIds="visWCorr" component="${component}"/> 
</ui:formGuide>
<ui:formGuide simulateEvents="${(current == 0 && componentView != 'compare') || (current == 1) ? 'true' : ''}">
  <ui:observe elementIds="hearAid" component="${component}" forValue="^1"/>
  <ui:unskip elementIds="hearWAid" component="${component}"/> 
</ui:formGuide>
