...
<page:applyDecorator name="component.content">
	...
	<page:param name="pageHeadingArgs"><spring:message code="naccNpExtract.pageTitle"/></page:param>
...
<content tag="customCriteria">
	...
	<tags:createField property="filter.params['customDateStart']" component="${component}" 
		metadataName="naccNpExtract.${component}.customDateStart" fieldId="${component}_${component}_customDateStart"/>
...
<content tag="customFormat">
	<tags:createField property="format" component="${component}" metadataName="naccNpExtract.${component}.format"/>
</content>
