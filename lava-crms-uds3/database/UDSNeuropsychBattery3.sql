...
where InstrType="UDS Neuropsych Battery 3";

delete instrumentsummary 
from instrumenttracking join instrumentsummary using (InstrID) 
where InstrType="UDS Neuropsych Battery 3";

delete udsneuropsychbattery3 
from instrumenttracking join udsneuropsychbattery3 using (InstrID) 
where InstrType="UDS Neuropsych Battery 3";
...
CREATE TABLE udsneuropsychbattery3 (
  InstrID int(10) NOT NULL,
    `MOCACOMP` smallint(5) DEFAULT NULL,
    `MOCAREAS` smallint(5) DEFAULT NULL,
    `MOCALOC` smallint(5) DEFAULT NULL,
    `MOCALAN` smallint(5) DEFAULT NULL,
    `MOCALANX` varchar(60) DEFAULT NULL,
    `MOCAVIS` smallint(5) DEFAULT NULL,
    `MOCAHEAR` smallint(5) DEFAULT NULL,
    `MOCATOTS` smallint(5) DEFAULT NULL,
    `MOCATRAI` smallint(5) DEFAULT NULL,
    `MOCACUBE` smallint(5) DEFAULT NULL,
    `MOCACLOC` smallint(5) DEFAULT NULL,
    `MOCACLON` smallint(5) DEFAULT NULL,
    `MOCACLOH` smallint(5) DEFAULT NULL,
    `MOCANAMI` smallint(5) DEFAULT NULL,
    `MOCAREGI` smallint(5) DEFAULT NULL,
    `MOCADIGI` smallint(5) DEFAULT NULL,
    `MOCALETT` smallint(5) DEFAULT NULL,
    `MOCASER7` smallint(5) DEFAULT NULL,
    `MOCAREPE` smallint(5) DEFAULT NULL,
    `MOCAFLUE` smallint(5) DEFAULT NULL,
    `MOCAABST` smallint(5) DEFAULT NULL,
    `MOCARECN` smallint(5) DEFAULT NULL,
    `MOCARECC` smallint(5) DEFAULT NULL,
    `MOCARECR` smallint(5) DEFAULT NULL,
    `MOCAORDT` smallint(5) DEFAULT NULL,
    `MOCAORMO` smallint(5) DEFAULT NULL,
    `MOCAORYR` smallint(5) DEFAULT NULL,
    `MOCAORDY` smallint(5) DEFAULT NULL,
    `MOCAORPL` smallint(5) DEFAULT NULL,
    `MOCAORCT` smallint(5) DEFAULT NULL,
    `NPSYCLOC` smallint(5) DEFAULT NULL,
    `NPSYLAN` smallint(5) DEFAULT NULL,
    `NPSYLANX` varchar(60) DEFAULT NULL,
    `CRAFTVRS` smallint(5) DEFAULT NULL,
    `CRAFTURS` smallint(5) DEFAULT NULL,
    `UDSBENTC` smallint(5) DEFAULT NULL,
    `DIGFORCT` smallint(5) DEFAULT NULL,
    `DIGFORSL` smallint(5) DEFAULT NULL,
    `DIGBACCT` smallint(5) DEFAULT NULL,
    `DIGBACLS` smallint(5) DEFAULT NULL,
    `ANIMALS` smallint(5) DEFAULT NULL,
    `VEG` smallint(5) DEFAULT NULL,
    `TRAILA` smallint(5) DEFAULT NULL,
    `TRAILARR` smallint(5) DEFAULT NULL,
    `TRAILALI` smallint(5) DEFAULT NULL,
    `TRAILB` smallint(5) DEFAULT NULL,
    `TRAILBRR` smallint(5) DEFAULT NULL,
    `TRAILBLI` smallint(5) DEFAULT NULL,
    `CRAFTDVR` smallint(5) DEFAULT NULL,
    `CRAFTDRE` smallint(5) DEFAULT NULL,
    `CRAFTDTI` smallint(5) DEFAULT NULL,
    `CRAFTCUE` smallint(5) DEFAULT NULL,
    `UDSBENTD` smallint(5) DEFAULT NULL,
    `UDSBENRS` smallint(5) DEFAULT NULL,
    `MINTTOTS` smallint(5) DEFAULT NULL,
    `MINTTOTW` smallint(5) DEFAULT NULL,
    `MINTSCNG` smallint(5) DEFAULT NULL,
    `MINTSCNC` smallint(5) DEFAULT NULL,
    `MINTPCNG` smallint(5) DEFAULT NULL,
    `MINTPCNC` smallint(5) DEFAULT NULL,
    `UDSVERFC` smallint(5) DEFAULT NULL,
    `UDSVERFN` smallint(5) DEFAULT NULL,
    `UDSVERNF` smallint(5) DEFAULT NULL,
    `UDSVERLC` smallint(5) DEFAULT NULL,
    `UDSVERLR` smallint(5) DEFAULT NULL,
    `UDSVERLN` smallint(5) DEFAULT NULL,
    `UDSVERTN` smallint(5) DEFAULT NULL,
    `UDSVERTE` smallint(5) DEFAULT NULL,
    `UDSVERTI` smallint(5) DEFAULT NULL,
    `COGSTAT` smallint(5) DEFAULT NULL,
