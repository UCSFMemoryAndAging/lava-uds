...
<page:applyDecorator name="component.content">
  ...
  <page:applyDecorator name="component.instrument.content">
    ...
    <page:applyDecorator name="component.instrument.section">
      ...
      <tags:createField property="strokedec" component="${component}" entity="${instrTypeEncoded}" labelAlignment="top"/>

      <tags:createField property="stkimag" component="${component}" entity="${instrTypeEncoded}" labelAlignment="top"/>

      <tags:createField property="infnetw" component="${component}" entity="${instrTypeEncoded}" labelAlignment="top"/>

      <tags:createField property="infwmh" component="${component}" entity="${instrTypeEncoded}" labelAlignment="top"/>
